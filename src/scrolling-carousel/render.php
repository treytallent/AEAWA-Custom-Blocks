...
<div <?php echo ($block_wrapper_attributes) ?>>
    <?php echo ($content)  ?>
    <div class="controls" data-wp-interactive="scrolling-carousel">
        <button data-wp-on--click="actions.decrementContainer"> <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <button data-wp-on--click="actions.incrementContainer"> <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
